...
#define STRING_CONFIG_H_AUTHOR "DrHideg" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  14.1336
    #define DEFAULT_KI   0.9550
    #define DEFAULT_KD 52.2943
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 129.3462
  #define DEFAULT_BED_KI  25.2629
  #define DEFAULT_BED_KD 441.5019
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 40, 200 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47.0, 0.0, -1.5 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
 ...
 */
#define EVENT_GCODE_BEFORE_G29 "G28"
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 47, 30 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z raise between tramming points
  #define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner
  #define BED_TRAMMING_USE_PROBE
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.025  // (mm)
...
#define PREHEAT_2_FAN_SPEED    38 // Value from 0 to 255
